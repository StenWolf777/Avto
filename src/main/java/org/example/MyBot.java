...
//                    list.add(row6);
                ...
                case "Eqm5w" -> {
                    List<InputMedia> list = new ArrayList<>();
                    InputMedia file1 = new InputMediaPhoto("https://static.tildacdn.one/tild3534-6337-4531-b839-646539306637/1.jpg");
                    InputMedia file3 = new InputMediaPhoto("https://static.tildacdn.one/tild3264-3666-4537-b234-383631653337/360.jpg");
                ...
                case "Dongfeng" -> {
                    ...
                    mediaList.add(new InputMediaPhoto("https://dongfeng.by/wp-content/uploads/2024/11/01.jpg"));
                    mediaList.add(new InputMediaPhoto("https://images.squarespace-cdn.com/content/v1/6350fe9b9cce4027e2441cdd/3d671b07-d126-4860-a37c-fe3576cdee8f/T5EVO_06.jpg"));
                    mediaList.add(new InputMediaPhoto("https://static.tildacdn.one/tild3633-3535-4865-a664-356565613134/dongfeng_forthing_t5.jpg"));
...
// Add more media items if needed (up to 10)
                ...
                case "Eqm5w-ru" -> {
                    List<InputMedia> list = new ArrayList<>();
                    InputMedia file1 = new InputMediaPhoto("https://autoreview.ru/images/gallery/%D0%9D%D0%BE%D0%B2%D0%BE%D1%81%D1%82%D0%B8/2021/June/22/hongqi-eqm5-8.jpg");
                    InputMedia file3 = new InputMediaPhoto("https://static.tildacdn.one/tild3264-3666-4537-b234-383631653337/360.jpg");
                    InputMedia file5 = new InputMediaPhoto("https://cdn.globalso.com/centuryautomobile/Hongqi-E-QM5-ZHU_6.jpg");
                    list.add(file1);
                    list.add(file3);
